...
```
## Warning: 18 files fail check - are present but should be absent
```
...
|Hand-edited data to override or complement openAlex data |./data/openalex/affiliations-imputed.Rds          |TRUE     |
|Records to remove from extracted openAlex data           |./data/openalex/blacklist.xlsx                    |TRUE     |
|NA                                                       |./data/auxiliary/mainOA-mapping.xlsx              |TRUE     |
|NA                                                       |./data/interwrk/crossref.diagnostics.Rds          |TRUE     |
|NA                                                       |./data/interwrk/hindex_request.csv                |TRUE     |
|NA                                                       |./data/interwrk/hindex_request.Rds                |TRUE     |
|NA                                                       |./data/interwrk/replication_list_3.Rds            |TRUE     |
|NA                                                       |./data/interwrk/replication_list_clean.Rds        |TRUE     |
...
- /home/rstudio/data/replication_data/crossref_aejdois.Rds - bibliographic information from Crossref for later analysis

Internet access is required to run the programs, unless the key input files [@raw-data-2019] are manually downloaded from [https://doi.org/10.5281/zenodo.2639920](https://doi.org/10.5281/zenodo.2639920).
...
|./programs/20_analytics.R                 |Old program, consolidates datasources into the main dataset, then conducts simple analyses. Most output appears only in the appendix. |
|./programs/25_prepare_sample.R            |NA                                                                                                                                    |
|./programs/30_results1.R                  |NA                                                                                                                                    |
|./programs/31_results2.R                  |NA                                                                                                                                    |
|./programs/32_conclusion.R                |NA                                                                                                                                    |
|./programs/35_appendix.R                  |NA                                                                                                                                    |
|./programs/36_list-articles.R             |NA                                                                                                                                    |
...
|./programs/42_prepare_authors.R           |NA                                                                                                                                    |
|./programs/43_supplementary4.R            |NA                                                                                                                                    |
|./programs/44_supplementary_authexp.R     |NA                                                                                                                                    |
|./programs/45_supplementary_hindex.R      |NA                                                                                                                                    |
|./programs/46_prepare_analysis.R          |NA                                                                                                                                    |
|./programs/47_prepare_mainOA.R            |NA                                                                                                                                    |
|./programs/48_mainOA_authorpaper_stats.R  |NA                                                                                                                                    |
|./programs/49_assignments.R               |NA                                                                                                                                    |
|./programs/50_analysis_openAlex.R         |NA                                                                                                                                    |
|./programs/51_analysis_Poisson.R          |NA                                                                                                                                    |
|./programs/52_robustess_standarderrors.R  |NA                                                                                                                                    |
|./programs/99_write_nums.R                |NA                                                                                                                                    |
|./programs/99_zz_info.R                   |NA                                                                                                                                    |
|./programs/config-private.R               |NA                                                                                                                                    |
|./programs/config.R                       |NA                                                                                                                                    |
|./programs/function_latexnums.R           |NA                                                                                                                                    |
|./programs/libraries.R                    |NA                                                                                                                                    |
|./text/libraries.R                        |NA                                                                                                                                    |
